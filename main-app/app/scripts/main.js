(function () {
    ...
    angular.module('Tombola.NoughtAndCrosses.gameboard',['Tombola.NoughtAndCrosses.core', 'Tombola.Tombola.NoughtAndCrosses.GameState', 'Tombola.NoughtAndCrosses.WinStates', 'Tombola.NoughtAndCrosses.cssSelection']);
